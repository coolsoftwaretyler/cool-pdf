...
import { BasicCacheFileNameScenario } from "./BasicCacheFileName";

export default function BasicCacheFileNameReactNativePdfScreen() {
    ...
    <View style={styles.container}>
      ...
      <Pdf
        source={{
          ...
          cache: true,
          cacheFileName: "my-custom-cached-file",
        }}
