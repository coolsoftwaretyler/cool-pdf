...
import { BasicUrlScenario } from './BasicUrlCoolPdfScreen';

export default function BasicUrlReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={BasicUrlScenario.name}
        description={BasicUrlScenario.description}
