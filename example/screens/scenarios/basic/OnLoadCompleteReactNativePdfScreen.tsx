...
import { OnLoadCompleteScenario } from "./OnLoadComplete";

export default function OnLoadCompleteReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={OnLoadCompleteScenario.name}
        description={OnLoadCompleteScenario.description}
