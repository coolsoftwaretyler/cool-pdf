...
import { PasswordIncorrectScenario } from "./PasswordIncorrect";

export default function PasswordIncorrectReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={PasswordIncorrectScenario.name}
        description={PasswordIncorrectScenario.description}
