...
import { ShowsVerticalScrollIndicatorScenario } from "./ShowsVerticalScrollIndicator";

export default function ShowsVerticalScrollIndicatorReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={ShowsVerticalScrollIndicatorScenario.name}
        description={ShowsVerticalScrollIndicatorScenario.description}
