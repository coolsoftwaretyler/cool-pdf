...
import { OnScaleChangedScenario } from "./OnScaleChanged";

export default function OnScaleChangedReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={OnScaleChangedScenario.name}
        description={OnScaleChangedScenario.description}
