...
import { PagePropScenario } from "./PageProp";

export default function PagePropReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={PagePropScenario.name}
        description={PagePropScenario.description}
