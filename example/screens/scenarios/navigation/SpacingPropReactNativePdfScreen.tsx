...
import { SpacingPropScenario } from "./SpacingProp";

export default function SpacingPropReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={SpacingPropScenario.name}
        description={SpacingPropScenario.description}
