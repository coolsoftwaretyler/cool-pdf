...
import { MaxScalePropScenario } from "./MaxScaleProp";

export default function MaxScalePropReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={MaxScalePropScenario.name}
        description={MaxScalePropScenario.description}
