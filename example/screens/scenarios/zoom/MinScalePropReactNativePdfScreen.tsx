...
import { MinScalePropScenario } from "./MinScaleProp";

export default function MinScalePropReactNativePdfScreen() {
  ...
  return (
    <View style={styles.container}>
      <ScenarioHeader
        ...
        name={MinScalePropScenario.name}
        description={MinScalePropScenario.description}
